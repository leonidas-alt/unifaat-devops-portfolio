...
**RA:** 4023575  
**Disciplina:** DevOps  
**Data das evidências:** 12/09/2026
...
Arquivo completo: [evidencias/aws-recursos.txt](evidencias/aws-recursos.txt)
...
Arquivo completo: [evidencias/s3-state.txt](evidencias/s3-state.txt)
...
Arquivo completo: [evidencias/rds-conexao.txt](evidencias/rds-conexao.txt)
...
Arquivo completo: [evidencias/psql-teste.txt](evidencias/psql-teste.txt)
...
O arquivo [evidencias/rds-conexao.txt](evidencias/rds-conexao.txt) também
registra `CREATE TABLE`, `INSERT 0 5` e o `SELECT * FROM orders` executado na
EC2 contra o RDS.

## Evidência do Terraform plan

Arquivo completo: [evidencias/terraform-plan.txt](evidencias/terraform-plan.txt)
...
- [evidencias/terraform-destroy.txt](evidencias/terraform-destroy.txt)
- [evidencias/terraform-destroy-backend.txt](evidencias/terraform-destroy-backend.txt)
